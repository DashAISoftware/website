          ...
          <div className="grid grid-cols-1 md:grid-cols-[220px_1fr]" style={{ minHeight: 480 }}>
            ...
            <div className="p-6 overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-5 pt-4 border-t border-border">
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 font-mono text-[11px] text-muted-foreground">
                ...
                <button className="bg-primary text-primary-foreground font-semibold text-[12.5px] px-4 py-2 rounded self-end sm:self-auto">
                  {t("main.train")}
                </button>
              </div>
            </div>
